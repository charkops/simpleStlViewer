...
namespace simpleStlViewer {
  ...
  Shader::Shader(const char *vertexPath, const char *fragmentPath) {
    // Retrieve vertex / fragment source code from files  
    ...
    if (!success) {
      ...
      std::cout << "ERROR::SHADER::FRAGMENT::COMPILATION_ERROR" << std::endl;
      std::cout << infoLog << std::endl;
    }
    ...
    if (!success) {
      ...
      std::cout << "ERROR::SHADER::PROGRAMM::LINKING_FAILED" << std::endl;
      std::cout << infoLog << std::endl;
    }
